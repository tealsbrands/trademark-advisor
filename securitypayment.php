   ...
   <div class="main_nav">
        <div class="container">   
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand logo" href="/" data-aos="fade-down" data-aos-duration="1000"> <img class="img-fluid" src="images/probookwhite.png" alt="logoa" style="width:25%;"> </a>
				...
				<div class="cardInfo">
					<div class="card myCardPay" >
						<div class="card-header text-center text-black">
							<h2 class="card-heading" style="color:black;">Invoice from Pro Book Publishing</h2>
											...
											<div id="main-row"  class="row">
												<div class="col-md-3">
													<div class="form-group">
														...
														<div class="">
															<input class="form-control " type="text" name="exp_month" placeholder="MM" minlength="2" maxlength="2" mailto: query@probookpublishing.com>
														</div>
