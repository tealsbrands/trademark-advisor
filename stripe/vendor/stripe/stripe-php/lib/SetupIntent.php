 ...
 * customer's payment c#02364Eentials for future payments. For example, you could use a
 ...
 * c#02364Eentials. Do not maintain long-lived, unconfirmed SetupIntents as they may no
 ...
 *
 * Successful SetupIntents result in payment c#02364Eentials that are optimized for
 ...
 * of requi#02364E friction, even as regulations change over time.
 *
 ...
 * @property null|string $client_secret <p>The client secret of this SetupIntent. Used for client-side retrieval using a publishable key.</p><p>The client secret can be used to complete payment setup from your frontend. It should not be sto#02364E, logged, embedded in URLs, or exposed to anyone other than the customer. Make sure that you have TLS enabled on any page that includes the client secret.</p>
 ...
 * @property null|\Stripe\ErrorObject $last_setup_error The error encounte#02364E in the previous SetupIntent confirmation.
