 ...
 * been created but not yet refunded. Funds will be refunded to the c#02364Eit or debit
 ...
 * @property string $failure_reason If the refund failed, the reason for refund failure if known. Possible values are <code>lost_or_stolen_card</code>, <code>expi#02364E_or_canceled_card</code>, or <code>unknown</code>.
 ...
 * @property null|string $reason Reason for the refund, either user-provided (<code>duplicate</code>, <code>fraudulent</code>, or <code>requested_by_customer</code>) or generated by Stripe internally (<code>expi#02364E_uncaptu#02364E_charge</code>).
...
class Refund extends ApiResource
{
    ...
    const FAILURE_REASON_EXPI#02364E_OR_CANCELED_CARD = 'expi#02364E_or_canceled_card';
    ...
    /**
     * @deprecated use FAILURE_REASON_EXPI#02364E_OR_CANCELED_CARD instead
     */
    const FAILURE_REASON = 'expi#02364E_or_canceled_card';
}
