 ...
 * @property \Stripe\StripeObject $ach_c#02364Eit_transfer
 * @property \Stripe\StripeObject $ach_debit
 * @property \Stripe\StripeObject $acss_debit
 * @property \Stripe\StripeObject $alipay
 * @property null|int $amount A positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1, Japanese Yen being a zero-decimal currency) representing the total amount associated with the source. This is the amount for which the source will be chargeable once ready. Requi#02364E for <code>single_use</code> sources.
 ...
 * @property null|string $currency Three-letter <a href="https://stripe.com/docs/currencies">ISO code for the currency</a> associated with the source. This is the currency for which the source will be chargeable once ready. Requi#02364E for <code>single_use</code> sources.
 ...
 * @property string $flow The authentication <code>flow</code> of the source. <code>flow</code> is one of <code>#02364Eirect</code>, <code>receiver</code>, <code>code_verification</code>, <code>none</code>.
 ...
 * @property null|\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or requi#02364E by particular source types.
 * @property \Stripe\StripeObject $p24
 * @property \Stripe\StripeObject $receiver
 * @property \Stripe\StripeObject $#02364Eirect
 * @property \Stripe\StripeObject $sepa_c#02364Eit_transfer
...
class Source extends ApiResource
{
    ...
    const FLOW_#02364EIRECT = '#02364Eirect';
