 ...
 * @property int $amount_capturable Amount that can be captu#02364E from this PaymentIntent.
 ...
 * @property null|int $canceled_at Populated when <code>status</code> is <code>canceled</code>, this is the time at which the PaymentIntent was canceled. Measu#02364E in seconds since the Unix epoch.
 ...
 * @property null|\Stripe\ErrorObject $last_payment_error The payment error encounte#02364E in the previous PaymentIntent confirmation. It will be clea#02364E if the PaymentIntent is later updated for any reason.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \Stripe\StripeObject $metadata Set of <a href="https://stripe.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structu#02364E format. For more information, see the <a href="https://stripe.com/docs/payments/payment-intents/creating-payment-intents#storing-information-in-metadata">documentation</a>.
...
class PaymentIntent extends ApiResource
{
     ...
     * @throws \Stripe\Exception\ApiErrorException if the request fails
     *
     * @return PaymentIntent the captu#02364E payment intent
     */
