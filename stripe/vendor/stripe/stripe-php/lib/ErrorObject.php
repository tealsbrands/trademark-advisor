...
class ErrorObject extends StripeObject
{
    ...
    const CODE_ALIPAY_UPGRADE_REQUI#02364E = 'alipay_upgrade_requi#02364E';
    const CODE_AMOUNT_TOO_LARGE = 'amount_too_large';
    const CODE_AMOUNT_TOO_SMALL = 'amount_too_small';
    const CODE_API_KEY_EXPI#02364E = 'api_key_expi#02364E';
    ...
    const CODE_BITCOIN_UPGRADE_REQUI#02364E = 'bitcoin_upgrade_requi#02364E';
    const CODE_CARD_DECLINED = 'card_declined';
    const CODE_CHARGE_ALREADY_CAPTU#02364E = 'charge_already_captu#02364E';
    ...
    const CODE_CHARGE_EXPI#02364E_FOR_CAPTURE = 'charge_expi#02364E_for_capture';
    const CODE_COUNTRY_UNSUPPORTED = 'country_unsupported';
    const CODE_COUPON_EXPI#02364E = 'coupon_expi#02364E';
    const CODE_CUSTOMER_MAX_SUBSCRIPTIONS = 'customer_max_subscriptions';
    const CODE_EMAIL_INVALID = 'email_invalid';
    const CODE_EXPI#02364E_CARD = 'expi#02364E_card';
    ...
    const CODE_ORDER_REQUI#02364E_SETTINGS = 'order_requi#02364E_settings';
    ...
    const CODE_PLATFORM_API_KEY_EXPI#02364E = 'platform_api_key_expi#02364E';
    ...
    const CODE_SECRET_KEY_REQUI#02364E = 'secret_key_requi#02364E';
