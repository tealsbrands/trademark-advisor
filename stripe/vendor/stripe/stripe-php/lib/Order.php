 ...
 * @property null|int $application_fee A fee in cents that will be applied to the order and transfer#02364E to the application owner’s Stripe account. The request must be made with an OAuth key or the Stripe-Account header in order to take an application fee. For more information, see the application fees documentation.
 ...
 * @property null|\Stripe\StripeObject[] $shipping_methods A list of supported shipping methods for this order. The desi#02364E shipping method can be specified either by updating the order, or when paying it.
 ...
 * @property null|int $updated Time at which the object was last updated. Measu#02364E in seconds since the Unix epoch.
