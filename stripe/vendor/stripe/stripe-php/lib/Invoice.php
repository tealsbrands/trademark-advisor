 ...
 *
 * If your invoice is configu#02364E to be billed through automatic charges, Stripe
 ...
 * connected to) have no webhooks configu#02364E, Stripe waits one hour after creation
 * to finalize the invoice.
 *
 * If your invoice is configu#02364E to be billed by sending an email, then based on
 ...
 *
 * Stripe applies any customer c#02364Eit on the account before determining the amount
 ...
 * @property int $amount_due Final amount due at this time for this invoice. If the invoice's total is smaller than the minimum charge amount, for example, or if there is account c#02364Eit that can be applied to the invoice, the <code>amount_due</code> may be 0. If there is a positive <code>starting_balance</code> for the invoice (the customer owes money), the <code>amount_due</code> will also take that into account. The charge that gets generated for the invoice will be for the amount specified in <code>amount_due</code>.
 ...
 * @property null|int $application_fee_amount The fee in %s that will be applied to the invoice and transfer#02364E to the application owner's Stripe account when the invoice is paid.
 ...
 * @property bool $paid Whether payment was successfully collected for this invoice. An invoice can be paid (most commonly) with a charge or with c#02364Eit from the customer's account balance.
 ...
 * @property int $post_payment_c#02364Eit_notes_amount Total amount of all post-payment c#02364Eit notes issued for this invoice.
 * @property int $pre_payment_c#02364Eit_notes_amount Total amount of all pre-payment c#02364Eit notes issued for this invoice.
 ...
 * @property null|string $statement_descriptor Extra information about an invoice for the customer's c#02364Eit card statement.
 ...
 * @property null|string|\Stripe\Subscription $subscription The subscription that this invoice was prepa#02364E for, if any.
 ...
 * @property null|int $webhooks_delive#02364E_at Invoices are automatically paid or sent 1 hour after webhooks are delive#02364E, or until all webhook delivery attempts have <a href="https://stripe.com/docs/billing/webhooks#understand">been exhausted</a>. This field tracks the time when webhooks for this invoice were successfully delive#02364E. If the invoice had no webhooks to deliver, this will be set while the invoice is being created.
 */
