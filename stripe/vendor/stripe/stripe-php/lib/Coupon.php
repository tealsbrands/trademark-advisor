 ...
 * @property null|int $max_#02364Eemptions Maximum number of times this coupon can be #02364Eeemed, in total, across all customers, before it is no longer valid.
 ...
 * @property null|int $#02364Eeem_by Date after which the coupon can no longer be #02364Eeemed.
 * @property int $times_#02364Eeemed Number of times this coupon has been applied to a customer.
