...
<body>
            ...
            <div id="main-row" class="row">
                ...
                <div class="col-md-6">
                    <div class="text-wrapper">
                        <h2>Get a Tailor-Made Website by <br><span>our expert designers</span></h2>
                        <ul>
                            <li>Launch Your Website in 24 Hours</li>
                            <li>Apply in Just 60 Seconds</li>
                            <li>Best Budget-Friendly Plans</li>
                        </ul>
    ...
    <section id="copyright-section">
        <div class="container">
            <div class="section-title text-center">
                <h2>Our Professional <span>Website<br> Design Solutions</span></h2>
            </div>
            <div   class="row">
                <div id="inner-row1" class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-wrapper">
                            ...
                            <p>Your website should be visually engaging, easy to navigate, and lightning-fast to capture visitors’ attention and drive conversions. Our web design services ensure a seamless user experience with modern design elements. Plus, we optimize your site for mobile devices, ensuring flawless performance on smartphones and tablets.</p>
                        </div>
                    </div>
                </div>
                <div id="inner-row2" class="row">
                    <div class="col-md-6">
                        <div class="text-wrapper">
                            <h3>E-Commerce <span>Solutions</span></h3>
                ...
                <div id="inner-row3"  >
                    ...
                    <div class="col-md-6">
                        <div class="text-wrapper">
                            <h3>Content Management System <span>(CMS)</span></h3>
                            <p>As the domain owner, you deserve full control over your website. Our CMS solutions empower you to create, manage, and modify content effortlessly—no coding required. With a user-friendly interface, you can easily add new features and maintain your business website with ease.</p>
                        </div>
                    </div>
                </div>
            </div>
