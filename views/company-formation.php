...
<body>
            ...
            <div id="main-row" class="row">
                ...
                <div class="col-md-6">
                    <div class="text-wrapper">
                        <h2>Incorporate <span>Your Company</span><br> for Just <span>$99</span></h2>
                        <ul>
                            <li>Launch Your Business Anywhere</li>
                            <li>All Business Structures Available for Formation</li>
                            <li>Hassle-Free Process – Incorporate Your Company Today!</li>
                        </ul>
    ...
    <section id="copyright-section">
        <div class="container">
            <div class="section-title text-center">
                <h2><span>Business Formation</span> Structures We Offer</h2>
            </div>
            <div   class="row">
                <div id="inner-row1" class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-wrapper">
                            <h3>Limited Liability Company <span>(LLC)</span></h3>
                            <p>Owners of a Limited Liability Company (LLC) are not personally liable for business losses, making it an ideal structure for small businesses. LLCs are cost-effective to establish and easier to manage compared to other corporate structures.</p>
                        </div>
                    </div>
                </div>
                <div id="inner-row2" class="row">
                    <div class="col-md-6">
                        <div class="text-wrapper">
                            <h3><span>S-Corporation</span></h3>
                            <p>A business can decide to be taxed as a pass-through entity by submitting an IRS S corporation election (IRS). These corporations can enjoy corporate income, losses, and deductions. S corporations are also advantageous when selling a business or shutting it down.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="img-bg">
                ...
                <div id="inner-row3"  >
                    ...
                    <div class="col-md-6">
                        <div class="text-wrapper">
                            <h3>Non-Profit <span>Organization</span></h3>
                            <p>Non-profit organizations operate without the goal of making a profit. Unlike LLCs, S-Corps, or C-Corps, their earnings are used to support their mission and compensate employees, while investors do not receive any financial returns.</p>
                        </div>
                    </div>
                </div>
            </div>
